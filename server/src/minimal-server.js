...
const server = app.listen(PORT, () => {
  ...
  console.log(`  GET  /api/tracking/:trackingNumber (Public Tracking)`);
  console.log(`  GET  /api/tracking/:trackingNumber/events (Events Only)`);
  console.log(`  GET  /api/tracking/:trackingNumber/route (Route Info)`);
  console.log(`  POST /api/tracking/:trackingNumber/subscribe (Notifications)`);
  console.log(`  GET  /api/tracking (Staff Dashboard)`);
  console.log(`  GET  /api/tracking/active (Active Shipments)`);
  console.log(`  GET  /api/tracking/overdue (Overdue Deliveries)`);
  console.log(`  GET  /api/tracking/stats (Analytics)`);
  console.log(`  POST /api/tracking (Create Tracking)`);
  console.log(`  POST /api/tracking/:trackingId/events (Add Event)`);
  console.log(`  POST /api/tracking/:trackingId/route (Update Route)`);
  console.log(`  POST /api/tracking/:trackingId/exceptions (Add Exception)`);
  console.log(`  PATCH /api/tracking/:trackingId/exceptions/:index/resolve (Resolve Exception)`);
  console.log(`  PATCH /api/tracking/:trackingId/delivery (Record Delivery)`);
  console.log(`\nAuthentication (NEW!):`);
