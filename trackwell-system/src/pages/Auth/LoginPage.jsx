...
const ContactAdminModal = ({ show, onClose }) => {
  const handleEmailAdmin = () => {
    window.location.href = 'mailto:dharanilekkala425@gmail.com?subject=Account Request&body=I would like to request access to MobiExpress Logistics system.';
  };
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                Contact your system administrator to get access to MobiExpress Logistics Management System.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: '32px' }}>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <span style={{ marginLeft: '8px', fontSize: '24px', fontWeight: 'bold', color: '#111827' }}>MobiExpress</span>
            </div>
          </div>
          <h2 style={{
            marginTop: '24px',
